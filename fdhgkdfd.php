    ...
    <div id="wrapper">
        ...
        <div class="container">
            ...
            <div class="text-center mb-4">
                <h1>Applying to RMU as a Foreign Applicant</h1>
                <p>
                    To apply as a foreign student, please read our International Student Application Guidelines. Once you
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="section-title">International Student Application Guidelines</div>
                    <div class="mb-5">
                        ...
                        <ol>
                            <li>Download and read the application guidelines.</li>
                            <li>Fill out the online application form with your accurate details.</li>
                            <li>Upload all required documents in the specified formats.</li>
                            <li>Submit the application and await your Reference Number via email or SMS.</li>
                            <li>Make the required payment using the provided bank details.</li>
                            <li>Keep a copy of your application and payment receipt for your records.</li>
                        </ol>
                    </div>
                    ...
                    <div class="processing-fees">
                        ...
                        <ul>
                            <li><strong>Masters/Upgraders programmes:</strong> $70.00</li>
                            <li><strong>BSc.programmes:</strong> $50.00</li>
                            <li><strong>Diploma/MEM programmes:</strong> $50.00</li>
                        </ul>
                    </div>
                </div>
