    ...
    <div id="wrapper">
        ...
        <div class="container">
            ...
            <div class="text-center mb-4">
                <h1>Applying to RMU as a Member State Applicant</h1>
                <p>
                    To apply as a member state student, please read our Member State Application Guidelines. Once you
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <!-- Member State Application Guidelines -->
                    <div class="section-title">Member State Application Guidelines</div>
                    <div class="mb-5">
                    ...
                    <div class="processing-fees">
                        ...
                        <ul>
                            ...
                            ?>
                                    <li><strong><?= $form['name'] ?>:</strong> $<?= $form['member_amount'] ?></li>
                            <?php
                                }
                            }
                            ?>
